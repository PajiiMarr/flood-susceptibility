...
function ZamboangaMask() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetch('/zamboanga_city.geojson').then(r => r.json()),
      fetch('/zamboanga_barangays.geojson').then(r => r.json()),
      ...
      // --- Barangay boundaries with white highlight ---
...
function FloodMap() {
  const position = [7.0736, 122.0100]
